    ...
    try:
        ...
        if len(all_papers) == 0:
            ...
            if recent_papers:
                ...
                print(f"Starting to save {len(recent_papers)} recent papers to DynamoDB...")
                ...
                for paper in recent_papers:
                    try:
                        ...
                        papers_table_ref.put_item(Item=paper_item)
                        saved_papers += 1
                        print(f"Successfully saved paper: {paper['arxiv_id']}")
                    ...
                    print(f"Error saving recent papers to DynamoDB: {e}")
